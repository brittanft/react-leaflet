(function (global, factory) {
	...
	function (_MapLayer) {
	  ...
	  createClass(Marker, [{
	    ...
	    value: function createLeafletElement(props) {
	      ...
	      this.contextValue = _objectSpread$9({}, props.leaflet, {
	        popupContainer: el
	      });
	      return el;
	    }
	  ...
	  createClass(Pane, [{
	    ...
	    value: function createPane(props) {
	      ...
	      if (map != null && map.createPane != null) {
	        ...
	        this.setState({
	          name: name,
	          context: _objectSpread$a({}, props.leaflet, {
	            pane: name
	          })
	        }, this.setStyle);
	      }
	...
	function (_DivOverlay) {
	  ...
	  createClass(Popup, [{
	    key: "getOptions",
	    value: function getOptions(props) {
	      return _objectSpread$b({}, get(getPrototypeOf$1(Popup.prototype), "getOptions", this).call(this, props), {
	        autoPan: false
	      });
	    }
	  }, {
